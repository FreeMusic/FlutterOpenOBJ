...
class ScreenUtil {
  ...
  void init(BuildContext context) {
    ...
    print("ScreenUtil======>>>>>> 设备的像素密度_pixelRatio: $_pixelRatio");
    print("ScreenUtil======>>>>>> 当前设备宽度_screenWidth: $_screenWidth");
    print("ScreenUtil======>>>>>> 当前设备高度_screenHeight: $_screenHeight");
    print("ScreenUtil======>>>>>> 状态栏高度_statusBarHeight: $_statusBarHeight");
    print("ScreenUtil======>>>>>> 底部安全区距离_bottomBarHeight: $_bottomBarHeight");
    print("ScreenUtil======>>>>>> 每个逻辑像素的字体像素数_textScaleFactor: $_textScaleFactor");
  }
