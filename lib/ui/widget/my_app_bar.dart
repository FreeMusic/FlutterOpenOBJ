...
enum YQAppBarStyle { light, dark }

class YQAppBar extends AppBar {
  final String text;
  final YQAppBarStyle style;
  final BuildContext context;
  final List<Widget> action;
  final PreferredSizeWidget bottomBar;

  YQAppBar({this.text, this.style, this.context, this.action, this.bottomBar});
  ...
  Widget get title => Text(
        ...
        style: TextStyle(
          color:
              (style == YQAppBarStyle.light) ? Color(0xFF333333) : Colors.white,
  ...
  Brightness get brightness =>
      (style == YQAppBarStyle.light) ? Brightness.light : Brightness.dark;
  @override
  // TODO: implement backgroundColor
  Color get backgroundColor =>
      (style == YQAppBarStyle.light) ? Colors.white : Colours.main_color;
  @override
  // TODO: implement leading
  Widget get leading => GestureDetector(
        child: Icon(
          Icons.arrow_back_ios,
          color: (style == YQAppBarStyle.light) ? Colors.black : Colors.white,
        ),
  ...
  PreferredSizeWidget get bottom => bottomBar;
}
